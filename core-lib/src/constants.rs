pub const CONFIG_FILE: &'static str = "./config.yml";

// define daps constants
...
// define here the config options you need from the yaml file
pub const DATABASE_URL: &'static str = "database_url";
pub const DATABASE_PORT: &'static str = "database_port";
pub const BLOCKCHAIN_API_URL: &'static str = "blockchain_api_url";
...
pub const INIT_DB: &'static str = "init_db";
